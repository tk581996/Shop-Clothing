<?php
ob_start(); // tránh lỗi header 'Cannot modify header information - headers already sent by... '
session_start();
?>
<!DOCTYPE HTML>
<html>
            ...
            <div class="mid-grids-style2-signup">
				<form method="post">
                		<table width="484" border="0">
                                  <tr>
                                    <th height="54" colspan="2" style="text-align:center;font-size:24px;color:#F69" scope="row">ĐĂNG NHẬP</th>
                                  </tr>
                                  <tr>
                                    <th height="40" style="text-align:right" scope="row">Email *</th>
                                  ...
                                  <tr>
                                  	<th scope="row"></th>
                                  	<td><input type="submit" name="login" value="Đăng nhập" id="dki"></td>
                                  </tr>
                        </table>
                </form>
                <div class="warning-login">
					<?php 
						include("modul/dangnhap.php");
						ob_end_flush(); // tránh lỗi header 'Cannot modify header information - headers already sent by... '
					?>
                </div>
            </div>
